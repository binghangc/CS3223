...
/**
 * The Scan class for the multi-buffer version of the <i>product</i> operator.
 * 
...
public class MultibufferProductScan implements Scan {
	...
	public MultibufferProductScan(Transaction tx, Scan lhsscan, String tblname, Layout layout, Predicate joinpred) {
		this.tx = tx;
		this.lhsscan = lhsscan;
		this.filename = tblname + ".tbl";
		this.layout = layout;
