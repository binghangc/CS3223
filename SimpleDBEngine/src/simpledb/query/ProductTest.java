...
public class ProductTest {
   public static void main(String[] args) throws Exception {
      ...
      TableScan ts1 = new TableScan(tx, "tempT1", layout1);

      Schema sch2 = new Schema();
      sch2.addIntField("C");
      sch2.addStringField("D", 9);
      Layout layout2 = new Layout(sch2);
      TableScan ts2 = new TableScan(tx, "tempT2", layout2);
      ...
      Scan s1 = new TableScan(tx, "tempT1", layout1);
      Scan s2 = new TableScan(tx, "tempT2", layout2);
      Scan s3 = new ProductScan(s1, s2);
      while (s3.next())
         System.out.println(s3.getString("B") + ' ' + s3.getString("D")); 
      s3.close();
      tx.commit();
   }
}
